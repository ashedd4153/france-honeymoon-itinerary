...
**Route:** La Cuchara de San Telmo (Start) → Bar Nestor (Tortilla/Steak) → La Viña (Cheesecake) → Ganbara (Mushrooms).
**Distance:** 400 meters (All in Old Town).
👉 **[Open Route in Google Maps](https://www.google.com/maps/dir/La+Cuchara+de+San+Telmo,+San+Sebasti%C3%A1n/Bar+Nestor,+San+Sebasti%C3%A1n/La+Vi%C3%B1a,+San+Sebasti%C3%A1n/Ganbara,+San+Sebasti%C3%A1n)**

### 🌉 2. Gros & Old Town "Mega-Loop" (The Full Experience)
**Route:** Bar Zabaleta (Gros Start) → Bar Bergara → Walk across Zurriola Bridge → Ganbara → Bar Nestor → La Viña (Finish).
**Distance:** ~1.5 km (Prove how close Gros actually is).
👉 **[Open Route in Google Maps](https://www.google.com/maps/dir/Bar+Zabaleta,+San+Sebasti%C3%A1n/Bar+Bergara,+San+Sebasti%C3%A1n/Ganbara,+San+Sebasti%C3%A1n/Bar+Nestor,+San+Sebasti%C3%A1n/La+Vi%C3%B1a,+San+Sebasti%C3%A1n)**

### ⚠️ A Note on Crowds (The Summer Reality)
**YES, these places will be mobbed in July/August.** 
Expect "shoulder-to-shoulder" crowds, "fighting" to order at the bar, and lines out the door.
*   **The Strategy:**
    *   **Go Early:** Start your evening crawl at **6:30 PM - 7:00 PM** (before the 8:30 PM local rush).
    *   **Lunch is Easier:** The 12:30 PM - 1:00 PM window is often slightly calmer than the night shift.
...
*Don't want to fight for your food? Go here.*
*   **Bar Zabaleta (Gros):** *The Alternative Tortilla.* widely considered equal to (or better than) Nestor's, and you don't have to queue for an hour.
*   **Bar Bergara (Gros):** A classic. Famous for the "Txalupa" (prawn & mushroom boat). Spacious and relaxed.
*   **Bar Antonio (Centro):** Excellent food, famous for their Ravioli of prawn and mushroom. A favorite of chefs.
...
*Why is this the "Game Changer" for Day 3?*
...
*   **Recommendation:** **Basque Land by Horse** (Oiartzun Valley) or **Hípica Loreak**.
*   **The Experience:** Request a **Private Guide** for advanced riders.
    *   **Terrain:** Mountain trails with ocean views (Peñas de Aya).
    *   **Pace:** Opportunity to **trot and canter** on open tracks (unlike the nose-to-tail beginner options).
    *   **Vibe:** Athletic and scenic, not "romantic/slow."
*   **Time:** Allow a full morning (pickup ~9:00 AM).

## 🍷 Wine
- **Txakoli** – the local crisp white, poured dramatically
- Abundant at every pintxos bar
- Rioja reds available everywhere
